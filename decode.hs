...
getGame n offset = do
    ...
    let getHeader :: Get a -> SGet a
        getHeader = getSegAt offset (printf "Game Nr. %d (Type %d)" n t)
    case t of
      6 -> do
...
getTipToiFile = do
    ...
    return (TipToiFile id raw_xor regs scripts games at at_doubled xor checksum checksumCalc)
